...
${DATA_DUMP_DIR}/rf_Q_star_model_%.object : ${DATA_DUMP_DIR}/rf_G_model_%.object ${DATA_DUMP_DIR}/rf_Q_model_%.object ${DATA_DUMP_DIR}/glmnet_Q_model_%.object ${DATA_DUMP_DIR}/disease_%.object  ${CUR_DIR}/build_rf_Q_star_model.R
