...
# ${DATA_DUMP_DIR}/rf_Q_star_model_%.object : ${DATA_DUMP_DIR}/rf_G_model_%.object ${DATA_DUMP_DIR}/rf_Q_model_%.object ${DATA_DUMP_DIR}/glmnet_Q_model_%.object ${DATA_DUMP_DIR}/disease_%.object ${DATA_DUMP_DIR}/rf_G_calibrated_model_%.object rf_Q_calibrated_model_%.object ${CUR_DIR}/build_rf_Q_star_model.R
# 	${RSCRIPT} ${CUR_DIR}/build_rf_Q_star_model.R ${DATA_DUMP_DIR}/rf_G_model_$*.object ${DATA_DUMP_DIR}/rf_Q_model_$*.object ${DATA_DUMP_DIR}/disease_$*.object $@ ${MATRIX_CACHE_DIR}

${DATA_DUMP_DIR}/rf_Q_star_model_%.object : ${DATA_DUMP_DIR}/rf_G_model_%.object ${DATA_DUMP_DIR}/rf_Q_model_%.object ${DATA_DUMP_DIR}/glmnet_Q_model_%.object ${DATA_DUMP_DIR}/disease_%.object ${DATA_DUMP_DIR}/rf_G_calibrated_model_%.object rf_Q_calibrated_model_%.object
