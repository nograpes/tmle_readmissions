...
%latex.default(pre.format, file = "", col.just = rep("r", 10),     cgroup = c("", "30-day readmission", "Time-to-readmission"),     n.cgroup = c(6, 2, 2), rowlabel = "Hospital", caption.loc = "bottom",     caption = pretty_names[disease], label = paste(disease, "table",         sep = "_"))%
\begin{table}[!tbp]
\begin{center}
